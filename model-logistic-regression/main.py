...
app = FastAPI(title="Logistic Regression Phishing Detector")
...
async def load_model():
    ...
    try:
        ...
        model_data = PickleCompatLoader.load("logistic_regression_model.pkl")
...
async def health_check():
    return {"status": "healthy", "model": "Logistic Regression", "loaded": model is not None}
...
@app.get("/")
async def root():
    return {"service": "Logistic Regression Phishing Detector", "status": "running"}
