...
## Overview
Guidelines for creating and maintaining Release Notes documentation.

## Documentation Requirements

### What Must Be Documented
- All release notes requests must be documented
- Changes to existing release notes arrangements
- Cancellations or modifications to release notes
- Changes and updates
- Lessons learned
