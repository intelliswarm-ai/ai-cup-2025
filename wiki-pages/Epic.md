...
## Overview
Guidelines for creating and maintaining Epic documentation.

## Documentation Requirements

### What Must Be Documented
- All epic requests must be documented
- Changes to existing epic arrangements
- Cancellations or modifications to epic
- Changes and updates
- Lessons learned
