# Action Items Documentation Standards

## Overview
Guidelines for creating and maintaining Action Items documentation.

## Documentation Requirements

### What Must Be Documented
- All action items requests must be documented
- Changes to existing action items arrangements
- Cancellations or modifications to action items
- Changes and updates
- Lessons learned
