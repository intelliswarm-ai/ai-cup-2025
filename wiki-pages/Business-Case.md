...
## Overview
Guidelines for creating and maintaining Business Case documentation.

## Documentation Requirements

### What Must Be Documented
- All business case requests must be documented
- Changes to existing business case arrangements
- Cancellations or modifications to business case
- Changes and updates
- Lessons learned
