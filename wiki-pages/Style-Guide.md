...
## Overview
Guidelines for creating and maintaining Style Guide documentation.

## Documentation Requirements

### What Must Be Documented
- All style guide requests must be documented
- Changes to existing style guide arrangements
- Cancellations or modifications to style guide
- Changes and updates
- Lessons learned
