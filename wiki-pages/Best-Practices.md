...
## Overview
Guidelines for creating and maintaining Best Practices documentation.

## Documentation Requirements

### What Must Be Documented
- All best practices requests must be documented
- Changes to existing best practices arrangements
- Cancellations or modifications to best practices
- Changes and updates
- Lessons learned
