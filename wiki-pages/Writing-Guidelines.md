...
## Overview
Guidelines for creating and maintaining Writing Guidelines documentation.

## Documentation Requirements

### What Must Be Documented
- All writing guidelines requests must be documented
- Changes to existing writing guidelines arrangements
- Cancellations or modifications to writing guidelines
- Changes and updates
- Lessons learned
