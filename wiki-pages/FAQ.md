...
## Overview
Guidelines for creating and maintaining FAQ documentation.

## Documentation Requirements

### What Must Be Documented
- All faq requests must be documented
- Changes to existing faq arrangements
- Cancellations or modifications to faq
- Changes and updates
- Lessons learned
