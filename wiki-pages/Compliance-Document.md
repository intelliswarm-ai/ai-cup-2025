# Compliance Document Documentation Standards

## Overview
Guidelines for creating and maintaining Compliance Document documentation.

## Documentation Requirements

### What Must Be Documented
- All compliance document requests must be documented
- Changes to existing compliance document arrangements
- Cancellations or modifications to compliance document
- Changes and updates
- Lessons learned
