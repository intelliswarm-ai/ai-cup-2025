# Retrospective Notes Documentation Standards

## Overview
Guidelines for creating and maintaining Retrospective Notes documentation.

## Documentation Requirements

### What Must Be Documented
- All retrospective notes requests must be documented
- Changes to existing retrospective notes arrangements
- Cancellations or modifications to retrospective notes
- Changes and updates
- Lessons learned
