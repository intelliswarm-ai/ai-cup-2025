# ERD Documentation Standards

## Overview
Guidelines for creating and maintaining ERD documentation.

## Documentation Requirements

### What Must Be Documented
- All erd requests must be documented
- Changes to existing erd arrangements
- Cancellations or modifications to erd
- Changes and updates
- Lessons learned
