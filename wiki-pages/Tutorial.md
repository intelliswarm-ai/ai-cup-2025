...
## Overview
Guidelines for creating and maintaining Tutorial documentation.

## Documentation Requirements

### What Must Be Documented
- All tutorial requests must be documented
- Changes to existing tutorial arrangements
- Cancellations or modifications to tutorial
- Changes and updates
- Lessons learned
