...
## Overview
Guidelines for creating and maintaining API documentation.

## Documentation Requirements

### What Must Be Documented
- All api requests must be documented
- Changes to existing api arrangements
- Cancellations or modifications to api
- Changes and updates
- Lessons learned
