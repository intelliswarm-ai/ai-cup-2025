...
## Overview
Guidelines for creating and maintaining Schema documentation.

## Documentation Requirements

### What Must Be Documented
- All schema requests must be documented
- Changes to existing schema arrangements
- Cancellations or modifications to schema
- Changes and updates
- Lessons learned
