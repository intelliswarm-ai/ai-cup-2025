...
## Overview
Guidelines for creating and maintaining Git Workflow documentation.

## Documentation Requirements

### What Must Be Documented
- All git workflow requests must be documented
- Changes to existing git workflow arrangements
- Cancellations or modifications to git workflow
- Changes and updates
- Lessons learned
