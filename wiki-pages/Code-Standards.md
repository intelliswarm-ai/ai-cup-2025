# Code Standards Documentation Standards

## Overview
Guidelines for creating and maintaining Code Standards documentation.

## Documentation Requirements

### What Must Be Documented
- All code standards requests must be documented
- Changes to existing code standards arrangements
- Cancellations or modifications to code standards
- Changes and updates
- Lessons learned
