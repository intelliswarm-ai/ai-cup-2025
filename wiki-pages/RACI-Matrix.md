# RACI Matrix Documentation Standards

## Overview
Guidelines for creating and maintaining RACI Matrix documentation.

## Documentation Requirements

### What Must Be Documented
- All raci matrix requests must be documented
- Changes to existing raci matrix arrangements
- Cancellations or modifications to raci matrix
- Changes and updates
- Lessons learned
