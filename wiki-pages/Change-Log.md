...
## Overview
Guidelines for creating and maintaining Change Log documentation.

## Documentation Requirements

### What Must Be Documented
- All change log requests must be documented
- Changes to existing change log arrangements
- Cancellations or modifications to change log
- Changes and updates
- Lessons learned
