# ROI Analysis Documentation Standards

## Overview
Guidelines for creating and maintaining ROI Analysis documentation.

## Documentation Requirements

### What Must Be Documented
- All roi analysis requests must be documented
- Changes to existing roi analysis arrangements
- Cancellations or modifications to roi analysis
- Changes and updates
- Lessons learned
