# Training Manual Documentation Standards

## Overview
Guidelines for creating and maintaining Training Manual documentation.

## Documentation Requirements

### What Must Be Documented
- All training manual requests must be documented
- Changes to existing training manual arrangements
- Cancellations or modifications to training manual
- Changes and updates
- Lessons learned
