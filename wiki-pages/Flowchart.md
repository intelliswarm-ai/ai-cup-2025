# Flowchart Documentation Standards

## Overview
Guidelines for creating and maintaining Flowchart documentation.

## Documentation Requirements

### What Must Be Documented
- All flowchart requests must be documented
- Changes to existing flowchart arrangements
- Cancellations or modifications to flowchart
- Changes and updates
- Lessons learned
