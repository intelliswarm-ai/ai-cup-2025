# Admin Guide Documentation Standards

## Overview
Guidelines for creating and maintaining Admin Guide documentation.

## Documentation Requirements

### What Must Be Documented
- All admin guide requests must be documented
- Changes to existing admin guide arrangements
- Cancellations or modifications to admin guide
- Changes and updates
- Lessons learned
