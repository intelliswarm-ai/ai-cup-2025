# Slides Documentation Standards

## Overview
Guidelines for creating and maintaining Slides documentation.

## Documentation Requirements

### What Must Be Documented
- All slides requests must be documented
- Changes to existing slides arrangements
- Cancellations or modifications to slides
- Changes and updates
- Lessons learned
