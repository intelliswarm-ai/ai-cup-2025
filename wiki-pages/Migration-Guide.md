# Migration Guide Documentation Standards

## Overview
Guidelines for creating and maintaining Migration Guide documentation.

## Documentation Requirements

### What Must Be Documented
- All migration guide requests must be documented
- Changes to existing migration guide arrangements
- Cancellations or modifications to migration guide
- Changes and updates
- Lessons learned
