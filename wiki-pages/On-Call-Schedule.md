# On-Call Schedule Documentation Standards

## Overview
Guidelines for creating and maintaining On-Call Schedule documentation.

## Documentation Requirements

### What Must Be Documented
- All on-call schedule requests must be documented
- Changes to existing on-call schedule arrangements
- Cancellations or modifications to on-call schedule
- Changes and updates
- Lessons learned
