# Mockup Documentation Standards

## Overview
Guidelines for creating and maintaining Mockup documentation.

## Documentation Requirements

### What Must Be Documented
- All mockup requests must be documented
- Changes to existing mockup arrangements
- Cancellations or modifications to mockup
- Changes and updates
- Lessons learned
