...
## Overview
Guidelines for creating and maintaining UML documentation.

## Documentation Requirements

### What Must Be Documented
- All uml requests must be documented
- Changes to existing uml arrangements
- Cancellations or modifications to uml
- Changes and updates
- Lessons learned
