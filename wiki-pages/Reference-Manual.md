# Reference Manual Documentation Standards

## Overview
Guidelines for creating and maintaining Reference Manual documentation.

## Documentation Requirements

### What Must Be Documented
- All reference manual requests must be documented
- Changes to existing reference manual arrangements
- Cancellations or modifications to reference manual
- Changes and updates
- Lessons learned
