...
app = FastAPI(title="SVM Phishing Detector")
...
async def load_model():
    ...
    try:
        ...
        model_data = PickleCompatLoader.load("svm_model.pkl")
...
async def health_check():
    return {"status": "healthy", "model": "SVM", "loaded": model is not None}
...
@app.get("/")
async def root():
    return {"service": "SVM Phishing Detector", "status": "running"}
